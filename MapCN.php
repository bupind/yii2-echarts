...
/**
 * <p>Implement for China Map chart based on Echarts</p>
 * @see http://echarts.baidu.com/examples.html
 */
class MapCN extends Echarts
{
     ...
     * @var string
     */
    public $title = 'China Map';

    /**
     * @var String the name of the statistical object.
     */
    public $category = 'object';

    /**
     * @var array <p>Expected city with number, such as ['成都'=>100]</p>
     */
    public $cityData = [];

    /**
     * @var array <p>province data with number, such ['四川'=>100]</p>
     */
    public $provinceData = [];

    /**
     * @var string the path of syboml
     */
    ...
    /**
     * @var array basic geo coords map
     */
    public $geoCoordMap = [
        '海门' => [121.15, 31.89],
    ...
    private function createSeriesData(){
        $data = [];
        foreach ($this->provinceData as $key => $val) {
    ...
    /**
     * get the expected city with coords.
     * @return array
     */
    private function convertData()
    {
        $data = [];
        foreach (array_keys($this->cityData) as $city) {
            if (array_key_exists($city, $this->geoCoordMap)) {
                $data[] = ['name' => $city, 'value' => $this->geoCoordMap[$city]];
            }
        }
        return $data;
    }
